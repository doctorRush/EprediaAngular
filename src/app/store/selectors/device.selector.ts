...
export const deviceTelemetry = createSelector(selectDevices, (state: IDeviceState) => state.deviceTelemetry);
export const notifications = createSelector(selectDevices, (state: IDeviceState) => state.notifications);
